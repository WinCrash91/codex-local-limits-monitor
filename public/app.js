...
(() => {
  ...
  function paint() {
    ...
    five.textContent = latest?.fiveHour ? pct.format(latest.fiveHour.remainingPercent) + ' %' : '—';
    week.textContent = latest?.weekly ? pct.format(latest.weekly.remainingPercent) + ' %' : '—';
    ...
    else fiveForecast.textContent = latest && !latest.fiveHour ? 'No disponible' : 'Sin proyección';
